...
se tiver células como "2026-04-02 00.00.00" coloque como "MM/DD/YY" (sem as horas)

Invalid calendar dates such as `2024-13-05`, `2024-02-30`, `April 31st, 2024`, and `2027-06-40` must become `INVALID`.

When you see data containing both a date and a location in the same field, remove the location and keep only the data.
If you cannot do this, mark it as "INVALID" to prevent hallucinations.
